...
- feat(fs): Implemented sys_rename ([#578](https://github.com/DragonOS-Community/DragonOS/pull/578))
- feat(fs): Implemented get_pathname ([#615](https://github.com/DragonOS-Community/DragonOS/pull/615))
- feat(kernel): Implemented uname system call ([#614](https://github.com/DragonOS-Community/DragonOS/pull/614))
- feat(fs): Added mount system call ([#561](https://github.com/DragonOS-Community/DragonOS/pull/561))
- feat(smp): Rewrote SMP module ([#633](https://github.com/DragonOS-Community/DragonOS/pull/633))
- feat(fs): Added Statx system call ([#632](https://github.com/DragonOS-Community/DragonOS/pull/632))
- feat(riscv64): Added flush tlb's IPI ([#636](https://github.com/DragonOS-Community/DragonOS/pull/636))
- feat(fs): Implemented SYS_LINK and SYS_LINKAT ([#611](https://github.com/DragonOS-Community/DragonOS/pull/611))
- fix(fs): mkdir outputs error message;
- fix(clippy): Fixed kernel clippy check errors ([#637](https://github.com/DragonOS-Community/DragonOS/pull/637))
- feat(net): Implemented socketpair ([#576](https://github.com/DragonOS-Community/DragonOS/pull/576))
- feat(process/riscv): Process management initialization ([#654](https://github.com/DragonOS-Community/DragonOS/pull/654))
- fix(time): Fixed clock_gettime return type error and fixed small time interval duration returning 0 issue ([#664](https://github.com/DragonOS-Community/DragonOS/pull/664))
- fix(driver/base): Changed Device trait's set_class to set a Weak pointer to avoid circular reference issues. ([#666](https://github.com/DragonOS-Community/DragonOS/pull/666))
- feat(textui): Supports drawing 24-bit and 16-bit deep display buffers ([#640](https://github.com/DragonOS-Community/DragonOS/pull/640))
- fix(driver/tty): Fixed bug where tty device appears in /sys directory ([#668](https://github.com/DragonOS-Community/DragonOS/pull/668))
- feat(fs): Added struct POSIXSTATFS and SuperBlock for handling statfs system call ([#667](https://github.com/DragonOS-Community/DragonOS/pull/667))
- feat(driver/rtc): Implemented rtc abstraction and integrated x86's cmos rtc into device driver model ([#674](https://github.com/DragonOS-Community/DragonOS/pull/674))
- fix(net): Fixed udp bind issue with port0 handling ([#676](https://github.com/DragonOS-Community/DragonOS/pull/676))
- fix(fs/ramfs): Fixed bug where move_to did not update parent field in ramfs ([#673](https://github.com/DragonOS-Community/DragonOS/pull/673))
- feat(mm): Implemented page reverse mapping ([#670](https://github.com/DragonOS-Community/DragonOS/pull/670))
- fix(misc): Fixed get_ramdom length error issue () ([#677](https://github.com/DragonOS-Community/DragonOS/pull/677))
- feat(process/riscv): riscv64: switch process ([#678](https://github.com/DragonOS-Community/DragonOS/pull/678))
- fix(misc): Made nproc correctly obtain the number of CPU cores ([#689](https://github.com/DragonOS-Community/DragonOS/pull/689))
- fix(time): Fixed jiffy clock being too fast, enabled gettimeofday test, modified mount test ([#680](https://github.com/DragonOS-Community/DragonOS/pull/680))
- feat(driver/pty): Implemented pty with test program ([#685](https://github.com/DragonOS-Community/DragonOS/pull/685))
- feat(process/riscv): Implemented copy-thread ([#696](https://github.com/DragonOS-Community/DragonOS/pull/696))
- feat(sched): Rewrote scheduling module ([#679](https://github.com/DragonOS-Community/DragonOS/pull/679))
- fix(riscv): Changed kernel compilation target to riscv64gc, obtained time csr frequency, and fixed assembly issues with floating point save and restore ([#699](https://github.com/DragonOS-Community/DragonOS/pull/699))
- feat(lock): Implemented robust futex ([#682](https://github.com/DragonOS-Community/DragonOS/pull/682))
- feat(fs): BlockCache-read cache support ([#521](https://github.com/DragonOS-Community/DragonOS/pull/521))
- feat(mm): Implemented SystemV shared memory ([#690](https://github.com/DragonOS-Community/DragonOS/pull/690))
- chore(tools): Add bootstrap support for Centos/RHEL8/fedora ([#713](https://github.com/DragonOS-Community/DragonOS/pull/713))
- feat(driver/pty): Improved pty, currently pty can support ssh ([#708](https://github.com/DragonOS-Community/DragonOS/pull/708))
- fix(smp): Fixed issue where smp startup damaged the idle process's kernel stack of the 0th core ([#711](https://github.com/DragonOS-Community/DragonOS/pull/711))
- feat(driver/riscv): Initialized riscv-sbi-timer ([#716](https://github.com/DragonOS-Community/DragonOS/pull/716))
- doc: Update DragonOS description and introduction ([#717](https://github.com/DragonOS-Community/DragonOS/pull/717))
- feat(riscv): Let riscv64 run hello world user program and complete all initcall ([#721](https://github.com/DragonOS-Community/DragonOS/pull/721))
- feat(net): Implemented tcp backlog feature ([#714](https://github.com/DragonOS-Community/DragonOS/pull/714))
- feat(mm): Added slab memory allocator ([#683](https://github.com/DragonOS-Community/DragonOS/pull/683))
- feat(fs): Introduced Umount system call ([#719](https://github.com/DragonOS-Community/DragonOS/pull/719))
- doc: Update build instructions for riscv64 architecture ([#725](https://github.com/DragonOS-Community/DragonOS/pull/725))
- fix(fs): Socket uniformly changed to `GlobalSocketHandle`, and fixed fcntl SETFD error ([#730](https://github.com/DragonOS-Community/DragonOS/pull/730))
- feat: Alarm system call implementation ([#710](https://github.com/DragonOS-Community/DragonOS/pull/710))
- feat(tty): Add dummy console ([#735](https://github.com/DragonOS-Community/DragonOS/pull/735))
- fix(driver/pci): pci: Uniformly use ecam root ([#744](https://github.com/DragonOS-Community/DragonOS/pull/744))
- feat(driver/pci): pci: Added pci root manager to manage pci root, enabling riscv to scan pci devices normally. ([#745](https://github.com/DragonOS-Community/DragonOS/pull/745))
- build: Upgraded smoltcp to version 0.11.0 ([#740](https://github.com/DragonOS-Community/DragonOS/pull/740))
- fix(unified-init): Fixed unified-init causing cargo check failure issue ([#747](https://github.com/DragonOS-Community/DragonOS/pull/747))
- chore: Update virtio-drivers to commit 61ece509c4 and modify max_queue_size implementation ([#748](https://github.com/DragonOS-Community/DragonOS/pull/748))
- feat(net): Implemented raw socket's poll ([#739](https://github.com/DragonOS-Community/DragonOS/pull/739))
- feat(mm): Implemented page fault handling, supports page delayed allocation and copy-on-write, and user stack auto-expansion ([#715](https://github.com/DragonOS-Community/DragonOS/pull/715))
- feat(driver): Added virtio to sysfs ([#752](https://github.com/DragonOS-Community/DragonOS/pull/752))
- fix(dog): Added CC environment variable to solve the problem of not finding musl-gcc during compilation ([#753](https://github.com/DragonOS-Community/DragonOS/pull/753))
- doc(community): Added description of conventional commit standard ([#754](https://github.com/DragonOS-Community/DragonOS/pull/754))
- feat(driver/virtio): riscv: Added virtio-blk driver, and can correctly mount FAT32 on riscv ([#761](https://github.com/DragonOS-Community/DragonOS/pull/761))
- feat(fs): Add sys_dup3 ([#755](https://github.com/DragonOS-Community/DragonOS/pull/755))
- feat(riscv): riscv can run hello world user program ([#770](https://github.com/DragonOS-Community/DragonOS/pull/770))
- feat(sched): Add sched_yield ([#766](https://github.com/DragonOS-Community/DragonOS/pull/766))
- refactor(process): Adjusted arch_switch_to_user function, extracted common logic between riscv and x86_64. ([#773](https://github.com/DragonOS-Community/DragonOS/pull/773))
- feat(driver/acpi_pm): Implement ACPI PM Timer ([#772](https://github.com/DragonOS-Community/DragonOS/pull/772))
- chore: Adapt to dadk 0.1.11 ([#777](https://github.com/DragonOS-Community/DragonOS/pull/777))
- fix(libs/lib_ui): Fixed display errors when system initializes ([#779](https://github.com/DragonOS-Community/DragonOS/pull/779))
- fix(riscv/process): Synchronized riscv's scheduling clock tick rate with HZ, and fixed the bug of forgetting to disable interrupts in kernel mode when switching to user mode ([#780](https://github.com/DragonOS-Community/DragonOS/pull/780))
- fix: (riscv/timer): Fixed bug where riscv did not update wall clock and did not handle soft interrupts ([#783](https://github.com/DragonOS-Community/DragonOS/pull/783))
- feat(mm): Add slab usage calculation ([#768](https://github.com/DragonOS-Community/DragonOS/pull/768))
- feat(bitmap): Add bit and for AllocBitMap ([#793](https://github.com/DragonOS-Community/DragonOS/pull/793))
- fix(mm): Fixed vma mapping flag error ([#801](https://github.com/DragonOS-Community/DragonOS/pull/801))
- feat:(riscv/intr) Implemented riscv plic driver, capable of handling external interrupts ([#799](https://github.com/DragonOS-Community/DragonOS/pull/799))
- doc(sched): Scheduling subsystem document and CFS document ([#807](https://github.com/DragonOS-Community/DragonOS/pull/807))
- fix(net): Fix TCP Unresponsiveness and Inability to Close Connections ([#791](https://github.com/DragonOS-Community/DragonOS/pull/791))
- fix: disable mm debug log to prevent system lockup due to thingbuf issue ([#808](https://github.com/DragonOS-Community/DragonOS/pull/808))
- feat(driver/pci): add pci bus into sysfs ([#792](https://github.com/DragonOS-Community/DragonOS/pull/792))
- doc: Add Gentoo Linux In build_system.md ([#810](https://github.com/DragonOS-Community/DragonOS/pull/810))

## Update Content - User Environment

### New Features / New Application Porting

- Added core utils to the system ([#624](https://github.com/DragonOS-Community/DragonOS/pull/624))
- Ported the --tcp functionality of the DNS query tool dog ([#652](https://github.com/DragonOS-Community/DragonOS/pull/652))

## Update Content - CI

- Introduced triagebot to classify issues and PRs
- Added automated workflow for clippy detection ([#649](https://github.com/DragonOS-Community/DragonOS/pull/649))
- ci: import issue checker ([#750](https://github.com/DragonOS-Community/DragonOS/pull/750))
- ci: update the match regex of issue checker ([#784](https://github.com/DragonOS-Community/DragonOS/pull/784))
- ci: Added one-click installation script for Gentoo system ([#809](https://github.com/DragonOS-Community/DragonOS/pull/809))
