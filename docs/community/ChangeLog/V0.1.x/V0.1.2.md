...
- Remove rust_helloworld file ([#113](https://github.com/DragonOS-Community/DragonOS/pull/113))
- Signal: Allow users to register signal handler functions, enabling custom handlers. ([#112](https://github.com/DragonOS-Community/DragonOS/pull/112))
...
- Add a custom stdint.h file in the kernel code ([#109](https://github.com/DragonOS-Community/DragonOS/pull/109))
- Adjust the script for compiling grub ([#108](https://github.com/DragonOS-Community/DragonOS/pull/108))
- Add 32-bit and 64-bit UEFI boot support ([#105](https://github.com/DragonOS-Community/DragonOS/pull/105))([#101](https://github.com/DragonOS-Community/DragonOS/pull/101))
- Use compiled installed grub-2.06 to solve the problem of compilation failure due to incorrect grub version on the client.
- Add a timekeeping module ([#106](https://github.com/DragonOS-Community/DragonOS/pull/106))
- Bugfix: Fix the issue where the rtc clock forgot to process the day field when converting to BCD code ([#104](https://github.com/DragonOS-Community/DragonOS/pull/104))
...
- procfs->status adds display of preempt and virtual runtime ([#100](https://github.com/DragonOS-Community/DragonOS/pull/100))
- ffz function: get the first bit that is 0 in a u64 ([#100](https://github.com/DragonOS-Community/DragonOS/pull/100))
- Solve the problem of local_irq_restore not being able to get the correct rflags value due to compiler optimization
- Refactor the serial port driver using Rust ([#99](https://github.com/DragonOS-Community/DragonOS/pull/99))

## Update Content - User Environment

- about app: Display the current git commit sha1 and build time ([#114](https://github.com/DragonOS-Community/DragonOS/pull/114))
- shell: Fix the error in the shell's exec command when concatenating absolute paths ([#114](https://github.com/DragonOS-Community/DragonOS/pull/114))
- shell: Add "&" background execution option for the exec command ([#100](https://github.com/DragonOS-Community/DragonOS/pull/100))
