...
- syscall: new: Add getpid system call ([#120](https://github.com/DragonOS-Community/DragonOS/pull/120))
- signal: update: Add all signals except SIGKILL to SigQueue ([#120](https://github.com/DragonOS-Community/DragonOS/pull/120))
- rtc: refactor: Refactor RTC driver using Rust ([#118](https://github.com/DragonOS-Community/DragonOS/pull/118))
- doc: new: Add documentation for signal ([#126](https://github.com/DragonOS-Community/DragonOS/pull/126))
- Spinlock: new: Add Rust-written RawSpinlock ([#127](https://github.com/DragonOS-Community/DragonOS/pull/127))
- arch: update: Change the path of the arch module in lib.rs, so that other modules can use the code in arch without specifying arch::x86_64 ([#128](https://github.com/DragonOS-Community/DragonOS/pull/128))
- mm: bugfix: Fix the bug where ZONE_NORMAL_INDEX was always 0 during initialization of the page allocator ([#129](https://github.com/DragonOS-Community/DragonOS/pull/129))
- scheduler: new: Refactor CFS scheduler using Rust ([#131](https://github.com/DragonOS-Community/DragonOS/pull/131))
- smp: Remove the HPET interrupt forwarding function that has been deprecated in smp ([#131](https://github.com/DragonOS-Community/DragonOS/pull/131))
- process: bugfix: Fix the issue where the init process forgot to set the fs and gs registers. ([#132](https://github.com/DragonOS-Community/DragonOS/pull/132))
- vfs: update: Rename the VFS folder to vfs ([#133](https://github.com/DragonOS-Community/DragonOS/pull/133))
- lockref: new: Add Rust version of lockref ([#135](https://github.com/DragonOS-Community/DragonOS/pull/135))
- cpu: new: Rust wrapper for cpu_relax(), using the pause instruction to let the CPU rest for a while, reducing idle power consumption. ([#135](https://github.com/DragonOS-Community/DragonOS/pull/135))
- Refactor softirq mechanism using Rust ([#138](https://github.com/DragonOS-Community/DragonOS/pull/138))

## Update Content - User Environment

- libc: bugfix: Always register sigkill when registering signal handlers ([#120](https://github.com/DragonOS-Community/DragonOS/pull/120))
- libc: new: Add raise, kill, abort ([#120](https://github.com/DragonOS-Community/DragonOS/pull/120))
- libc: new: Add an arch folder, and add crt0, crti, crtn files under it ([#134](https://github.com/DragonOS-Community/DragonOS/pull/134))
- libc: new: Add `fflush()`, `fprintf()`, `stdin`, `stdout`, `stderr`, `ferror()`, `fopen()`, `fclose()`, `putchar()`, `puts()` ([#136](https://github.com/DragonOS-Community/DragonOS/pull/136))
- libc: new: Simply add `fopen()` for handling the mode parameter. Please note that it does not fully comply with POSIX, and is inconsistent with Linux. It will be improved when using Rust in the future. ([#141](https://github.com/DragonOS-Community/DragonOS/pull/141))
- Porting: new: Add porting and build scripts for gmp, mpfr, and mpc ([#136](https://github.com/DragonOS-Community/DragonOS/pull/136))
- Porting: new: Add cross-compilation build scripts for gcc and binutils, as well as patches for gcc-11.3.0 and binutils-2.38 (in the DragonOS-community repository) ([#136](https://github.com/DragonOS-Community/DragonOS/pull/136))
- compile: update: Update the include path for the compiler, so that includes do not need the `<libc/src/include/>` prefix ([#124](https://github.com/DragonOS-Community/DragonOS/pull/124))

## Update Content - Others

- bugfix: Fix the bug where Docker installation would exit abnormally ([#116](https://github.com/DragonOS-Community/DragonOS/pull/116))
- new: Add a new GCC bare-metal compiler targeting x86_64-elf, and use it to compile DragonOS ([#111](https://github.com/DragonOS-Community/DragonOS/pull/111))
- update: Update the Docker build image to version `dragonos/dragonos-dev:v1.2`, and support building this build image from a Dockerfile ([#111](https://github.com/DragonOS-Community/DragonOS/pull/111))
- bugfix: Fix the bug where the MBR disk image did not set the boot flag ([#111](https://github.com/DragonOS-Community/DragonOS/pull/111))
- update: Update the GitHub workflow, add cache, and speed up build checks
- bugfix: Fix the error message when downloading grub2.06 ([#125](https://github.com/DragonOS-Community/DragonOS/pull/125))
