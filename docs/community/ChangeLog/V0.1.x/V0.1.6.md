...
- softirq: Refactored softirq ([#223](https://github.com/DragonOS-Community/DragonOS/pull/223))
- timer: Refactored system timer ([#223](https://github.com/DragonOS-Community/DragonOS/pull/223))
- stdio: Added tty device for standard input and output ([#202](https://github.com/DragonOS-Community/DragonOS/pull/202)) ([#217](https://github.com/DragonOS-Community/DragonOS/pull/217))
- lib: First set of keyboard scan code state machine ([#216](https://github.com/DragonOS-Community/DragonOS/pull/216)) ([#219](https://github.com/DragonOS-Community/DragonOS/pull/219))
- syscall: Added dup and dup2 system calls ([#224](https://github.com/DragonOS-Community/DragonOS/pull/224))
- syscall: Added SystemError enum type to make error handling clearer ([#205](https://github.com/DragonOS-Community/DragonOS/pull/205))
- driver: Added support for x87 floating-point processor ([#212](https://github.com/DragonOS-Community/DragonOS/pull/212))
- driver: VirtIO network card can now send and receive data normally ([#204](https://github.com/DragonOS-Community/DragonOS/pull/204))
- filesystem: Fixed FAT32 judgment logic, resolving the issue where the system could not boot normally when the file system was FAT12/16. ([#211](https://github.com/DragonOS-Community/DragonOS/pull/211))
- filesystem: Added VFS document and modified document configuration ([#209](https://github.com/DragonOS-Community/DragonOS/pull/209))
- textui: Fixed the issue where the process scheduler did not run when "processes output characters continuously" due to textui locking and changes in preempt_count. ([#203](https://github.com/DragonOS-Community/DragonOS/pull/203))
- scheduler: Solved the issue of double locking in cpu_queue caused by not disabling interrupts during sched_enqueue outside of interrupt context. ([#201](https://github.com/DragonOS-Community/DragonOS/pull/201))
...
- build: Added an option for using VNC as the image output for QEMU ([#222](https://github.com/DragonOS-Community/DragonOS/pull/222))
