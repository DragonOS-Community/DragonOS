...
- refactor: Refactor system call module ([#267](https://github.com/DragonOS-Community/DragonOS/pull/267))
- feature: Add AlignBox and int_like macros ([#272](https://github.com/DragonOS-Community/DragonOS/pull/272))
- refactor: Rewrite new IPI function & kick_cpu function ([#274](https://github.com/DragonOS-Community/DragonOS/pull/274))
- feature: Implement gettimeofday() system call and clocksource+timekeeping sub-module ([#278](https://github.com/DragonOS-Community/DragonOS/pull/278))
- refactor: Reconstruct PCI device interrupts and remove USB-related code ([#285](https://github.com/DragonOS-Community/DragonOS/pull/285))
- feature: Register serial device, create character device framework ([#290](https://github.com/DragonOS-Community/DragonOS/pull/290))
- refactor: New memory management module ([#303](https://github.com/DragonOS-Community/DragonOS/pull/303))
- feature: New binary loader, elf parser ([#303](https://github.com/DragonOS-Community/DragonOS/pull/303))
- feature: Add ListenTable to detect port occupation ([#291](https://github.com/DragonOS-Community/DragonOS/pull/291))
- feature: Replace local_irq_save with IrqFlagsGuard implementation ([#317](https://github.com/DragonOS-Community/DragonOS/pull/317))
- feature: Implement system call Fstat ([#295](https://github.com/DragonOS-Community/DragonOS/pull/295))
- feature: Implement kernel notifier chain ([#316](https://github.com/DragonOS-Community/DragonOS/pull/316))
- feature: Add fcntl system call ([#323](https://github.com/DragonOS-Community/DragonOS/pull/323))
- feature: Add support for per CPU variables ([#327](https://github.com/DragonOS-Community/DragonOS/pull/327))
- feature: Spinlock guard adds leak, spinlock adds force unlock function ([#329](https://github.com/DragonOS-Community/DragonOS/pull/329))

### Bug Fixes

- bugfix: Fix the issue of not being able to read stdin normally ([#264](https://github.com/DragonOS-Community/DragonOS/pull/264))
- bugfix: Fix the memory overflow problem when the buffer address passed to the AHCI driver is a user buffer (temporarily solved by allocating a kernel buffer) ([#265](https://github.com/DragonOS-Community/DragonOS/pull/265))
- bugfix: Solve the bug caused by the improper assembly of local_irq_save and local_irq_restore functions affecting stack behavior ([#303](https://github.com/DragonOS-Community/DragonOS/pull/303))
- bugfix: Solve the error of local_irq_save not disabling interrupts ([#303](https://github.com/DragonOS-Community/DragonOS/pull/303))
- bugfix: Solve the error in arch_try_cmpxchg for pointer handling ([#307](https://github.com/DragonOS-Community/DragonOS/pull/307))
- bugfix: Fix the exception error in wait4 ([#312](https://github.com/DragonOS-Community/DragonOS/pull/312))
- bugfix: Fix the issue of null device and zero device not being able to open and not behaving as expected ([#314](https://github.com/DragonOS-Community/DragonOS/pull/314))
- bugfix: Fix the bug in FAT file system not correctly extending file size ([#323](https://github.com/DragonOS-Community/DragonOS/pull/323))
- bugfix: Fix the use after free issue caused by not using ManuallyDrop in some places of rwlock ([#329](https://github.com/DragonOS-Community/DragonOS/pull/329))

## Update Content - User Environment

### New Features

- feature: Add new HTTP server ([#265](https://github.com/DragonOS-Community/DragonOS/pull/265))

### Bug Fixes

- bugfix: Solve the issue of the init segment linking error caused by crt*.o not being sorted in ascending order during linking ([#265](https://github.com/DragonOS-Community/DragonOS/pull/265))

## Update Content - Others

- bugfix: Fix the toolchain and resolve errors caused by the new Rust compiler ([#258](https://github.com/DragonOS-Community/DragonOS/pull/258))
- feature: Makefile: Add make help command in the root directory ([#271](https://github.com/DragonOS-Community/DragonOS/pull/271))
- doc: Update GitHub issue template ([#277](https://github.com/DragonOS-Community/DragonOS/pull/277))
- bugfix: Fix the issue where the relibc header file could not recognize the __dragonos__ definition ([#315](https://github.com/DragonOS-Community/DragonOS/pull/315))
- feature: Set the remote for the kernel and relibc to the DragonOS Git mirror site to prevent compilation failure due to domestic network issues ([#318](https://github.com/DragonOS-Community/DragonOS/pull/318))
- feature: Automatic installation and update of dadk ([#319](https://github.com/DragonOS-Community/DragonOS/pull/319))

## Update Content - Software Porting

- feature: Ported sqlite3 ([#323](https://github.com/DragonOS-Community/DragonOS/pull/323))
