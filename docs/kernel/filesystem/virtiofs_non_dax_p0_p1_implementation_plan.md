...
“candidate 已实现并进入最终验证”。当前复核基线是 `origin/master=33681d8e`；此前 `14606afc` 只称
...
projection；该 correctness 修复同时进入双方，最终 baseline 为 `2a8f5e25`，candidate 为
`e8aae407..9b8b77b9`，避免把“baseline 无法启动”冒充性能收益。
