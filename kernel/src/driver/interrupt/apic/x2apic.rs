use x86::msr::{IA32_APIC_BASE, IA32_X2APIC_SIVR, IA32_X2APIC_VERSION, IA32_X2APIC_EOI, IA32_X2APIC_APICID, wrmsr,rdmsr};



use super::{LocalAPIC, LVTRegister, LVT};
...
impl LocalAPIC for X2Apic{
    ...
    fn init_current_cpu(&mut self) -> bool {
        unsafe {
            wrmsr(IA32_APIC_BASE.into(), rdmsr(IA32_APIC_BASE.into()) | 1 << 10);
