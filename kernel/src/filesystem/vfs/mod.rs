...
pub trait FileSystem: Any + Sync + Send + Debug {
    ...
    /// Return the device/source field used by procfs mount exports.
    fn proc_show_devname(&self, mount: &MountFS) -> Result<Option<String>, SystemError> {
        Ok(mount.mount_source())
    }
