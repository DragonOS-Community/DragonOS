...
fn ktime_get_real() -> ktime_t {
    ...
    //转换成纳秒
    let timestamp: ktime_t = day_count as u64 * 86_400_000_000_000u64
        + (rtc_time.hour - 8) as u64 * 3_600_000_000_000u64
        + rtc_time.minute as u64 * 60_000_000_000u64
        + rtc_time.second as u64 * 1_000_000_000u64 as ktime_t;
