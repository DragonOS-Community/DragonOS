...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Ubuntu 11.3.0-1ubuntu1~22.04) 11.3.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=I386_EFI -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/11/include -I$(top_srcdir)/include -I$(top_builddir)/include'
