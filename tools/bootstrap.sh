...
rustInstall() {
	...
	if [ -z "$(which rustc)" ]; then
		...
		rustup toolchain install nightly-2024-05-14-x86_64-unknown-linux-gnu
		rustup component add rust-src --toolchain nightly-2023-08-15-x86_64-unknown-linux-gnu
		rustup component add rust-src --toolchain nightly-2024-05-14-x86_64-unknown-linux-gnu
		rustup target add x86_64-unknown-none --toolchain nightly-2023-08-15-x86_64-unknown-linux-gnu
		rustup target add x86_64-unknown-none --toolchain nightly-2024-05-14-x86_64-unknown-linux-gnu
		rustup target add x86_64-unknown-linux-musl --toolchain nightly-2024-05-14-x86_64-unknown-linux-gnu

		rustup toolchain install nightly-2023-08-15-riscv64gc-unknown-linux-gnu --force-non-host
		rustup toolchain install nightly-2024-05-14-riscv64gc-unknown-linux-gnu --force-non-host
		...
		rustup target add riscv64gc-unknown-none-elf --toolchain nightly-2024-05-14-riscv64gc-unknown-linux-gnu
		rustup target add riscv64imac-unknown-none-elf --toolchain nightly-2024-05-14-riscv64gc-unknown-linux-gnu
...
#
# 为DragonOS开发应用的时候，请使用 `cargo +nightly-2024-05-14-x86_64-unknown-linux-gnu build --target x86_64-unknown-linux-musl` 来编译
# 	这样编译出来的应用将能二进制兼容DragonOS 
####################################################################################
initialize_userland_musl_toolchain()
{
	fork_toolchain_from="nightly-2024-05-14-x86_64-unknown-linux-gnu"
	custom_toolchain="nightly-2024-05-14-x86_64-unknown-linux_dragonos-gnu"
