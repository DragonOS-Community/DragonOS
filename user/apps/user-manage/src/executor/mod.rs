...
fn open_file(file_path: &str) -> File {
    ...
    let exit_status = match file_path {
        "/etc/group" => crate::error::ExitStatus::GroupFile,
        "/etc/gshadow" => crate::error::ExitStatus::GshadowFile,
        "/etc/passwd" => crate::error::ExitStatus::PasswdFile,
        "/etc/shadow" => crate::error::ExitStatus::ShadowFile,
        _ => crate::error::ExitStatus::InvalidArg,
    };
